    ...
    return `
        <div class="inline-drawer">
            ...
            <div class="inline-drawer-content">
                ...
                <label>Flow B (phone reply prompt template):
                    <textarea data-sp="flowBPromptTemplate" rows="6" style="width:100%"></textarea>
                </label>
...
function wire(panel) {
    ...
    panel.querySelector('[data-sp-action="clearThread"]').addEventListener('click', () => {
        if (confirm('Clear phone thread for this chat?')) {
            storage.clearThread();
            badge.refresh();
            modal.refresh();
    ...
    panel.querySelector('[data-sp-action="clearAll"]').addEventListener('click', () => {
        if (confirm('Clear ALL phone data (thread + summary) for this chat?')) {
            storage.clearThread();
